...
import UserMenuController from "./controllers/user_menu_controller.js?20260322.1";
import SessionController from "./controllers/session_controller.js?20260322.1";
import TimelineController from "./controllers/timeline_controller.js?20260322.1";
import ReaderController from "./controllers/reader_controller.js?20260322.1";
import HighlightController from "./controllers/highlight_controller.js?20260213.1";
import HighlightsController from "./controllers/highlights_controller.js?20260322.1";
import SubscriptionsController from "./controllers/subscriptions_controller.js?20260322.1";
import DiscoverController from "./controllers/discover_controller.js?20260322.1";
...
import { init_listener } from "./router.js?20260322.1";
